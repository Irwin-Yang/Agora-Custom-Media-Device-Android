...
package io.agora.rtc.ss.app.renderer.filter;
...
import io.agora.rtc.ss.app.renderer.Rotation;
import io.agora.rtc.ss.app.renderer.TextureRotationUtil;

import static io.agora.rtc.ss.app.renderer.ImageFilterRenderer.CUBE;
...
public class ImageFilterGroup extends ImageFilter {
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.gpuimage.ImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.gpuimage.ImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * jp.co.cyberagent.android.gpuimage.ImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.gpuimage.ImageFilter#onDraw(int,
